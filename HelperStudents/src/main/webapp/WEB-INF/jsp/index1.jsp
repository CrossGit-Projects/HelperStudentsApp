                       ...
                       <div class="banner_inner d-flex align-items-center">
           				...
           				<div class="container">
           					<div class="banner_content text-center">
           						...
           						<a class="main_btn" href="/register">Rozpocznij Teraz!</a>
           					</div>
           				</div>
                       </div>
                   </section>
                            		...
                            		<div class="row latest_blog_inner">
                            			<div class="col-lg-3 col-md-6">
                            				<div class="l_blog_item">
                            					<img class="img-fluid" src="/resources/images/l-blog-1.jpg" alt="">
                            			...
                            			<div class="col-lg-3 col-md-6">
                            				<div class="l_blog_item">
                            					<img class="img-fluid" src="/resources/images/l-blog-2.jpg" alt="">
                            					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
                            					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
                            					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
                            				</div>
                            			...
                            			<div class="col-lg-3 col-md-6">
                            				<div class="l_blog_item">
                            					<img class="img-fluid" src="/resources/images/l-blog-3.jpg" alt="">
                            					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
                            					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
                            					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
                            				</div>
                            			...
                            			<div class="col-lg-3 col-md-6">
                            				<div class="l_blog_item">
                            					<img class="img-fluid" src="/resources/images/l-blog-4.jpg" alt="">
                            					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
                            					<a href="single-blog.html"><h4>Addiction When Gambling Becomes A Problem</h4></a>
                            					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
                            				</div>
